/**
 * Homepage V2 hero behaviour. V2 now carries V1's hero markup and is wired by
 * the same ef-search-bar.js, so these cover the ported behaviour end to end
...
test.describe('homepage V2 hero', () => {
  ...
  test('renders the V1 hero with the Community CTA', async ({ page }) => {
