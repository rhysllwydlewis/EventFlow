...
function Z(e) {
  if (O) {
    if (/* @__PURE__ */ Be(P) !== null) throw (hr(), bt);
    P = e;
  }
}
function aa() {
    ...
    new Proxy(
      ...
      e,
      {
        defineProperty(c, f, d) {
          ...
          return (
            m === void 0
              ? ((m = s(() => /* @__PURE__ */ N(d.value))), r.set(f, m))
              : b(
                  m,
                  s(() => Me(d.value))
                ),
        ...
        get(c, f, d) {
          ...
          if (
            (m === void 0 &&
              (!v || rt(c, f)?.writable) &&
              ((m = s(() => /* @__PURE__ */ N(Me(v ? c[f] : ae)))), r.set(f, m)),
            m !== void 0)
          ) {
            var _ = i(m);
        ...
        has(c, f) {
          if (f === Ot) return !0;
          var d = r.get(f),
            m = (d !== void 0 && d.v !== ae) || Reflect.has(c, f);
        ...
        set(c, f, d, m) {
          var v = r.get(f),
            _ = f in c;
          if (o && f === 'length')
            for (var w = d; w < /** @type {Source<number>} */ v.v; w += 1) {
              var F = r.get(w + '');
              F !== void 0
                ? b(F, ae)
                : w in c && ((F = s(() => /* @__PURE__ */ N(ae))), r.set(w + '', F));
            }
          v === void 0
            ? (!_ || rt(c, f)?.writable) &&
              ((v = s(() => /* @__PURE__ */ N(void 0))),
              b(
                v,
                s(() => Me(d))
              ),
        ...
        ownKeys(c) {
          ...
          for (var [d, m] of r) m.v !== ae && !(d in c) && f.push(d);
          return f;
        },
        setPrototypeOf() {
          oa();
...
function J(e, t = 1, r = !1) {
  ...
  return (Ue(o), /** @type {TemplateNode} */ o);
}
function sa(e) {
  e.textContent = '';
}
...
function co(e) {
  var t = uo(e),
    r = (Ve || (e.f & fe) !== 0) && e.deps !== null ? at : le;
  (_e(e, r), e.equals(t) || ((e.v = t), (e.wv = xo())));
}
function fa(e) {
  (S === null && $ === null && Qi(),
    $ !== null && ($.f & fe) !== 0 && S === null && Xi(),
    qt && Ki());
}
function da(e, t) {
  var r = t.last;
...
function je(e, t = !0) {
  ...
  ((t || (e.f & zi) !== 0) &&
    ...
    _e(e, dr));
  var o = e.transitions;
  if (o !== null) for (const a of o) a.stop();
  ho(e);
  var l = e.parent;
  (l !== null && l.first !== null && po(e),
...
function pr(e, t, r, o) {
  if (tr) {
    if ((r === null && (tr = !1), Mn(t))) throw e;
    return;
  }
  if ((r !== null && (tr = !0), wa(e, t), Mn(t))) throw e;
}
function Co(e, t, r = !0) {
  var o = e.reactions;
  if (o !== null)
...
function ko(e) {
  var t = re,
    ...
    f = ke,
    d = e.f;
  ((re = /** @type {null | Value[]} */ null),
    (ce = 0),
    (he = null),
    (Ve = (d & fe) !== 0 && (ke || !nt || $ === null)),
    ($ = (d & (De | it)) === 0 ? e : null),
    (Te = null),
    Vn(e.ctx),
    (ke = !1),
  ...
  try {
    ...
    if (re !== null) {
      ...
      if ((cr(e, ce), v !== null && ce > 0))
        for (v.length = ce + re.length, _ = 0; _ < re.length; _++) v[ce + _] = re[_];
      else e.deps = v = re;
      if (!Ve) for (_ = ce; _ < v.length; _++) (v[_].reactions ??= []).push(e);
    } else v !== null && ce < v.length && (cr(e, ce), (v.length = ce));
    if (To() && he !== null && !ke && v !== null && (e.f & (me | at | Ie)) === 0)
      for (_ = 0; _ < /** @type {Source[]} */ he.length; _++)
        Co(
          he[_],
          /** @type {Effect} */
          e
    ...
    return (
      l !== null &&
        l !== e &&
        (ur++, he !== null && (o === null ? (o = he) : o.push(.../** @type {Source[]} */ he))),
      m
    );
  } finally {
...
function Ea(e, t) {
  ...
  r === null &&
    (t.f & me) !== 0 && // Destroying a child effect while updating a parent effect can cause a dependency to appear
...
function cr(e, t) {
  var r = e.deps;
  if (r !== null) for (var o = t; o < r.length; o++) Ea(e, r[o]);
}
function Wr(e) {
  var t = e.f;
  if ((t & dr) === 0) {
        ...
        try {
          Bt(o) &&
            ...
            o.deps === null &&
              o.first === null &&
              o.nodes_start === null &&
              (o.teardown === null ? po(o) : (o.fn = null)));
        } catch (l) {
          pr(l, o, null, o.ctx);
        }
    }
...
function i(e) {
  ...
  return (r && ((l = /** @type {Derived} */ e), Bt(l) && co(l)), qt && jt.has(e) ? jt.get(e) : e.v);
}
function ot(e) {
  var t = ke;
  try {
...
function Da(e, t, r, o = {}) {
  function l(a) {
    if ((o.capture || Pt.call(t, a), !a.cancelBubble)) return No(() => r?.call(this, a));
  }
  return (
...
function Pt(e) {
  ...
  if (c) {
    var f = l.indexOf(c);
    if (f !== -1 && (t === document || t === /** @type {any} */ window)) {
      e.__root = t;
      return;
    }
    var d = l.indexOf(t);
  ...
  if (((a = /** @type {Element} */ l[s] || e.target), a !== t)) {
    Mt(e, 'currentTarget', {
      configurable: !0,
      get() {
        return a || r;
    ...
    try {
      for (var _, w = []; a !== null; ) {
        ...
        try {
          ...
          if (
            M != null &&
            (!(/** @type {any} */ a.disabled) || // DOM could've been updated already by the time this is reached, so we check this as well
...
function be(e, t) {
  ...
  return () => {
    ...
    l === void 0 &&
      ((l = Zr(a ? e : '<!>' + e)), r || (l = /** @type {Node} */ /* @__PURE__ */ ve(l)));
    var s =
      /** @type {TemplateNode} */
  ...
  try {
    for (
      var a =
        /** @type {TemplateNode} */
        /* @__PURE__ */ ve(r);
      a && (a.nodeType !== 8 || /** @type {Comment} */ a.data !== Mr);
    )
      a = /** @type {TemplateNode} */ /* @__PURE__ */ Be(a);
    if (!a) throw bt;
    (_t(!0),
      Ue(
        /** @type {Comment} */
    ...
    if (P === null || P.nodeType !== 8 || /** @type {Comment} */ P.data !== zn) throw (hr(), bt);
    return (_t(!1), /**  @type {Exports} */ s);
  } catch (s) {
    if (s === bt) return (t.recover === !1 && ta(), Tr(), sa(r), _t(!1), Po(e, t));
    throw s;
  } finally {
    (_t(o), Ue(l));
  }
    ...
    f = v => {
      for (var _ = 0; _ < v.length; _++) {
        ...
        if (!c.has(w)) {
          ...
          var M = pt.get(w);
          M === void 0
            ? (document.addEventListener(w, Pt, { passive: F }), pt.set(w, 1))
            : pt.set(w, M + 1);
        }
      }
    };
      ...
      if (O && o !== -1) {
        if (r === 0) {
          ...
          U === Mr
            ...
            : U === Zn
              ? (o = 1 / 0)
              : ((o = parseInt(U.substring(1))), o !== o && (o = c ? 1 / 0 : -1));
        }
        const M = o > r;
  ...
  Ce(() => {
    ...
    if (
      (c.nodes_start !== null &&
        ...
        (c.nodes_start = c.nodes_end = null)),
      s !== '')
    ) {
      if (O) {
        P.data;
        for (
          var f = Et(), d = f;
          f !== null && (f.nodeType !== 8 || /** @type {Comment} */ f.data !== '');
        )
          ((d = f), (f = /** @type {TemplateNode} */ /* @__PURE__ */ Be(f)));
        if (f === null) throw (hr(), bt);
        (Ae(P, d), (a = Ue(f)));
        return;
      }
      var m = s + '';
      ...
      var v = Zr(m);
      if (
        ((r || o) && (v = /** @type {Element} */ /* @__PURE__ */ ve(v)),
        Ae(
          /** @type {TemplateNode} */
          /* @__PURE__ */ ve(v),
          /** @type {TemplateNode} */
...
function R(e, t, r, o) {
  ...
  (O &&
    ...
    (l[t] !== (l[t] = r) &&
      ...
      r == null
        ? e.removeAttribute(t)
        : typeof r != 'string' && Ba(e).includes(t)
          ? (e[t] = r)
          : e.setAttribute(t, r)));
}
function Fo(e) {
...
function Wa(e, t = yt) {
  ...
  function l(c) {
    if (lo(e, c) && ((e = c), r)) {
      const f = !mt.length;
      for (const d of o) (d[1](), mt.push(d, e));
      if (f) {
        for (let d = 0; d < mt.length; d += 2) mt[d][0](mt[d + 1]);
        mt.length = 0;
      }
    }
  }
...
function x(e, t, r, o) {
  ...
  s
    ...
    : (d = /** @type {V} */ e[t]);
  var m = Ot in e || ro in e,
    v = (s && (rt(e, t)?.set ?? (m && t in e && (j => (e[t] = j))))) || void 0,
    _ =
      /** @type {V} */
      o,
    w = !0,
  ...
  return (
    ...
    function (j, se) {
      if (arguments.length > 0) {
        ...
        if (!X.equals(He)) {
          if (((ee = !0), b($e, He), F && _ !== void 0 && (_ = He), Gn(X))) return j;
          ot(() => i(X));
        }
        return j;
      }
...
typeof HTMLElement == 'function' &&
  (Uo = class extends HTMLElement {
          ...
          (this.$$me = ha(() => {
            Hr(() => {
              ...
              for (const o of or(this.$$c)) {
                ...
                this.$$d[o] = this.$$c[o];
                const l = nr(o, this.$$d[o], this.$$p_d, 'toAttribute');
                l == null
                  ? this.removeAttribute(this.$$p_d[o].attribute || o)
                  : this.setAttribute(this.$$p_d[o].attribute || o, l);
              }
              this.$$r = !1;
            });
          })));
    ...
    attributeChangedCallback(e, t, r) {
      this.$$r ||
        ((e = this.$$g_p(e)),
        (this.$$d[e] = nr(e, r, this.$$p_d, 'toProp')),
...
function nr(e, t, r, o) {
  const l = r[e]?.type;
  if (((t = l === 'Boolean' && typeof t != 'boolean' ? t != null : t), !o || !r[e])) return t;
  if (o === 'toAttribute')
    switch (l) {
      case 'Object':
      case 'Array':
...
function Qa(e, t, r, o, l, a) {
  let s = class extends Uo {
    ...
    static get observedAttributes() {
      return or(t).map(c => (t[c].attribute || c).toLowerCase());
    }
  };
  return (
    or(t).forEach(c => {
...
async function qo(e, t, r) {
  ...
  return el(await crypto.subtle.digest(r.toUpperCase(), jo.encode(e + t)));
}
...
function ol(e, t = 12) {
  ...
  for (let o = 0; o < t; o++) ((r[o] = e % 256), (e = Math.floor(e / 256)));
  return r;
}
async function il(e, t = '', r = 1e6, o = 0) {
  const l = 'AES-GCM',
    ...
    c = async () => {
      for (let m = o; m <= r; m += 1) {
        if (a.signal.aborted || !f || !d) return null;
        try {
  ...
  try {
    d = nl(e);
    const m = await crypto.subtle.digest('SHA-256', jo.encode(t));
    f = await crypto.subtle.importKey('raw', m, l, !1, ['decrypt']);
  } catch {
    return {
...
var cl = /* @__PURE__ */ _r(
  ...
  fl = /* @__PURE__ */ be('<input type="hidden">'),
  dl = /* @__PURE__ */ be(
  ...
  pl = /* @__PURE__ */ be('<button type="button" class="altcha-code-challenge-audio"><!></button>'),
  ml = /* @__PURE__ */ be('<audio hidden autoplay><source></audio>'),
  _l = /* @__PURE__ */ be(
  ...
  bl = /* @__PURE__ */ be('<div><!></div>'),
  yl = /* @__PURE__ */ be('<div><!></div>'),
  wl = /* @__PURE__ */ be(
  ...
  El = /* @__PURE__ */ be('<div class="altcha-footer"><div><!></div></div>'),
  xl = /* @__PURE__ */ be('<div class="altcha-anchor-arrow"></div>'),
  Cl = /* @__PURE__ */ be(
...
function kl(e, t) {
  $o(t, !0);
  const [r, o] = Za(),
    l = () => Ya(Wo, '$altchaI18nStore', r);
  let a = x(t, 'auto', 7, void 0),
    s = x(t, 'blockspam', 7, void 0),
    c = x(t, 'challengeurl', 7, void 0),
    f = x(t, 'challengejson', 7, void 0),
    d = x(t, 'credentials', 7, void 0),
    m = x(t, 'customfetch', 7, void 0),
    v = x(t, 'debug', 7, !1),
    _ = x(t, 'delay', 7, 0),
    w = x(t, 'disableautofocus', 7, !1),
    F = x(t, 'refetchonexpire', 7, !0),
    M = x(t, 'disablerefetchonexpire', 23, () => !F()),
    U = x(t, 'expire', 7, void 0),
    I = x(t, 'floating', 7, void 0),
    ee = x(t, 'floatinganchor', 7, void 0),
    $e = x(t, 'floatingoffset', 7, void 0),
    X = x(t, 'floatingpersist', 7, !1),
    j = x(t, 'hidefooter', 7, !1),
    se = x(t, 'hidelogo', 7, !1),
    He = x(t, 'id', 7, void 0),
    Ht = x(t, 'language', 7, void 0),
    Ge = x(t, 'name', 7, 'altcha'),
    We = x(t, 'maxnumber', 7, 1e6),
    xt = x(t, 'mockerror', 7, !1),
    Ne = x(t, 'obfuscated', 7, void 0),
    ge = x(t, 'overlay', 7, void 0),
    Ct = x(t, 'overlaycontent', 7, void 0),
    Gt = x(t, 'plugins', 7, void 0),
    Ye = x(t, 'sentinel', 7, void 0),
    ye = x(t, 'spamfilter', 7, !1),
    st = x(t, 'strings', 7, void 0),
    de = x(t, 'test', 7, !1),
    te = x(t, 'verifyurl', 7, void 0),
    ut = x(t, 'workers', 23, () => Math.min(16, navigator.hardwareConcurrency || 8)),
    kt = x(t, 'workerurl', 7, void 0);
  const { altchaI18n: Go } = globalThis,
    Wo = Go.store,
    zr = ['SHA-256', 'SHA-384', 'SHA-512'],
    Yo = 'https://altcha.org/',
    Le = (n, u) => {
      t.$$host.dispatchEvent(new CustomEvent(n, { detail: u }));
    },
    Jr = document.documentElement.lang?.split('-')?.[0],
    br = /* @__PURE__ */ Lt(
      () =>
        c() &&
        new URL(c(), location.origin).host.endsWith('.altcha.org') &&
        !!c()?.includes('apiKey=ckey_')
    ),
    Wt = /* @__PURE__ */ Lt(() => (f() ? fn(f()) : void 0)),
    Zo = /* @__PURE__ */ Lt(() => (st() ? fn(st()) : {})),
    L = /* @__PURE__ */ Lt(() => ({
      ...Qr(l()),
      ...i(Zo),
    })),
  ...
  (Dr(() => {
    ...
    Ga(() => {
      (zo(),
        b(Rt, null),
        i(T) &&
          (i(T).removeEventListener('submit', an),
          i(T).removeEventListener('reset', ln),
          i(T).removeEventListener('focusin', on),
          b(T, null)),
        we && (clearTimeout(we), (we = null)),
        document.removeEventListener('click', rn),
        document.removeEventListener('scroll', nn),
        window.removeEventListener('resize', cn));
    }),
    Mo(() => {
      (A('mounted', '2.2.4'),
        A('workers', ut()),
        Qo(),
        A('plugins', Oe.length ? Oe.map(n => n.constructor.pluginName).join(', ') : 'none'),
        de() && A('using test mode'),
        U() && xr(U()),
        a() !== void 0 && A('auto', a()),
        I() !== void 0 && gn(I()),
        b(T, i(V)?.closest('form'), !0),
        i(T) &&
          (i(T).addEventListener('submit', an, { capture: !0 }),
          i(T).addEventListener('reset', ln),
          (a() === 'onfocus' || X() === 'focus') && i(T).addEventListener('focusin', on)),
        ge() && pn(!0),
        a() === 'onload' && (Ne() ? $t() : Se()),
        i(br) &&
          (j() || se()) &&
  ...
  function zo() {
    for (const n of Oe) n.destroy();
  }
  function Xr() {
    c() && !M() && i(k) === y.VERIFIED ? Se() : Ke(y.EXPIRED, i(L).expired);
  }
  async function Jo() {
    if (xt()) throw (A('mocking error'), new Error('Mocked error.'));
    if (i(Wt)) return (A('using provided json data'), dn(i(Wt).salt), i(Wt));
    if (de())
      return (
        A('generating test challenge', { test: de() }),
        tl(typeof de() != 'boolean' ? +de() : void 0)
      );
    {
      if (!c() && i(T)) {
      ...
      if (!c()) throw new Error('Attribute challengeurl not set.');
      ...
      if (u.status !== 200) throw new Error(`Server responded with ${u.status}.`);
      const h = u.headers.get('X-Altcha-Config'),
        p = await u.json();
      if ((dn(p.salt), h))
        try {
          ...
          g &&
            typeof g == 'object' &&
            (g.verifyurl && !g.verifyurl.startsWith('fn:') && (g.verifyurl = tn(g.verifyurl)),
            bn(g));
        } catch (g) {
  ...
  function Ko(n) {
    const u = i(T)?.querySelector(
      typeof n == 'string' ? `input[name="${n}"]` : 'input[type="email"]:not([data-no-spamfilter])'
    );
  ...
  function Qr(n, u = [Ht() || '', document.documentElement.lang || '', ...navigator.languages]) {
    const h = Object.keys(n).map(g => g.toLowerCase()),
      p = u.reduce(
        (g, C) => (
          (C = C.toLowerCase()),
          g || (n[C] ? C : null) || h.find(D => C.split('-')[0] === D.split('-')[0]) || null
        ),
        null
      );
    return n[p || 'en'];
...
`
  ...
  function tn(n, u) {
    const h = new URL(c() || location.origin),
      p = new URL(n, h);
    if ((p.search || (p.search = h.search), u))
      for (const g in u) u[g] !== void 0 && u[g] !== null && p.searchParams.set(g, u[g]);
    return p.toString();
  }
  function Qo() {
  ...
  function A(...n) {
    (v() || n.some(u => u instanceof Error)) &&
      console[n[0] instanceof Error ? 'error' : 'log']('ALTCHA', `[name=${Ge()}]`, ...n);
  }
  function ei() {
    b(W, Q.PAUSED, !0);
  }
  ...
  function ai(n) {
    if ((n.preventDefault(), n.stopPropagation(), i(G))) {
      ...
      (b(Je, !0),
        hn(Yt(i(G).challenge, i(G).solution), h)
          .then(({ reason: p, verified: g }) => {
            g
              ? (b(G, null),
                xe(y.VERIFIED),
                A('verified'),
                Rr().then(() => {
                  (i(yr)?.focus(),
                    Le('verified', { payload: i(Ee) }),
                    a() === 'onsubmit' ? vn(i(Rt)) : ge() && St());
                }))
  ...
  function rn(n) {
    ...
    I() &&
      ...
      !i(V).contains(u) &&
      ((i(k) === y.VERIFIED && X() === !1) ||
        (i(k) === y.VERIFIED && X() === 'focus' && !i(T)?.matches(':focus-within')) ||
        (a() === 'off' && i(k) === y.UNVERIFIED)) &&
      St();
  }
  function nn() {
  ...
  function li(n) {
    for (const u of Oe) typeof u.onErrorChange == 'function' && u.onErrorChange(i(ze));
  }
  function on(n) {
    i(k) === y.UNVERIFIED ? Se() : I() && X() === 'focus' && i(k) === y.VERIFIED && Zt();
  }
  function an(n) {
    n.target?.hasAttribute('data-code-challenge-form') ||
      (b(Rt, n.submitter, !0),
      i(T) && a() === 'onsubmit'
        ? (i(Rt)?.blur(),
          i(k) === y.UNVERIFIED
            ...
            : i(k) !== y.VERIFIED &&
              (n.preventDefault(), n.stopPropagation(), i(k) === y.VERIFYING && sn()))
        : i(T) &&
          I() &&
          a() === 'off' &&
          i(k) === y.UNVERIFIED &&
  ...
  function si(n) {
    for (const u of Oe) typeof u.onStateChange == 'function' && u.onStateChange(i(k));
    (I() &&
      i(k) !== y.UNVERIFIED &&
      requestAnimationFrame(() => {
        Tt();
      ...
      b(At, i(k) === y.VERIFIED),
      ge() && i(ue) && (i(k) !== y.UNVERIFIED ? Zt() : St()));
  }
  function cn() {
    I() && Tt();
  }
  ...
  function dn(n) {
    const u = new URLSearchParams(n.split('?')?.[1]),
      h = u.get('expires') || u.get('expire');
    if (h) {
      const p = new Date(+h * 1e3),
        g = isNaN(p.getTime()) ? 0 : p.getTime() - Date.now();
      g > 0 && xr(g);
    } else we && (clearTimeout(we), (we = null));
  }
  async function ui(n) {
    if (!te()) throw new Error('Attribute verifyurl not set.');
    ...
    if (ye() !== !1) {
      ...
      ((u.blockedCountries = g),
        (u.classifier = C),
        (u.disableRules = D),
        (u.email = H === !1 ? void 0 : Ko(H)),
        (u.expectedCountries = oe),
        (u.expectedLanguages = q || (Jr ? [Jr] : void 0)),
        (u.fields = ie === !1 ? void 0 : en(ie)),
        (u.ipAddress = Qe === !1 ? void 0 : Qe || 'auto'),
        (u.text = dt),
        (u.timeZone = et === !1 ? void 0 : et || Wn()));
    }
    const h = await Er()(te(), {
    ...
    if (!h || !(h instanceof Response))
      throw new Error('Custom fetch function did not return a response.');
    if (h.status !== 200) throw new Error(`Server responded with ${h.status}.`);
    const p = await h.json();
    if (
      (p?.payload && b(Ee, p.payload, !0),
      Le('serververification', p),
      s() && p.classification === 'BAD')
    )
  ...
  async function hn(n, u) {
    ...
    Ye() &&
      ((h.fields = Ye().fields ? en() : void 0), (h.timeZone = Ye().timeZone ? Wn() : void 0));
    const p = await Er()(te(), {
    ...
    if (p.status !== 200) throw new Error(`Server responded with ${p.status}.`);
    const g = await p.json();
    return (g?.payload && b(Ee, g.payload, !0), Le('sentinelverification', g), g);
  }
  function vn(n) {
    i(T) && 'requestSubmit' in i(T)
      ? i(T).requestSubmit(n)
      : i(T)?.reportValidity() && (n ? n.click() : i(T).submit());
  }
  function xr(n) {
    (A('expire', n),
      we && (clearTimeout(we), (we = null)),
      n < 1 ? Xr() : (we = setTimeout(Xr, n)));
  }
  function gn(n) {
    (A('floating', n),
      I() !== n && ((i(V).style.left = ''), (i(V).style.top = '')),
      I(n === !0 || n === '' ? 'auto' : n === !1 || n === 'false' ? void 0 : I()),
      I()
        ? (a() || a('onsubmit'),
          document.addEventListener('scroll', nn),
  ...
  function pn(n) {
    if ((A('overlay', n), ge(n), n)) {
      if (
        (a() || a('onsubmit'),
        i(ue) && i(V).parentElement && i(ue).replaceWith(i(V).parentElement),
        i(V)?.parentElement?.parentElement)
      ) {
        (b(ue, document.createElement('div'), !0),
          i(V).parentElement.parentElement.appendChild(i(ue)));
        ...
        ((h.type = 'button'),
          ...
          i(ue).classList.add('altcha-overlay-backdrop'),
          h.classList.add('altcha-overlay-close-button'),
          u.classList.add('altcha-overlay'),
          i(ue).append(u),
          u.append(h),
          Ct() && u.append(...document.querySelectorAll(Ct())),
          u.append(i(V).parentElement));
      }
    } else
      i(ue) &&
        i(V).parentElement &&
        (i(ue).replaceWith(i(V).parentElement), (i(V).style.display = 'block'));
  }
  function mn(n) {
  ...
  async function _n(n) {
    ...
    if ('Worker' in window) {
      try {
        ((u = ci(n, n.maxNumber || n.maxnumber || We())),
          b(Ze, u.controller, !0),
          (h = await u.promise));
      } catch (p) {
        A(p);
      ...
      if (h === null || h?.number !== void 0 || 'obfuscated' in n) return { data: n, solution: h };
    }
    if ('obfuscated' in n) {
      const p = await il(n.obfuscated, n.key, n.maxNumber || n.maxnumber);
      return { data: n, solution: await p.promise };
    }
    ((u = rl(n.challenge, n.salt, n.algorithm, n.maxNumber || n.maxnumber || We())),
      b(Ze, u.controller, !0));
    try {
      h = await u.promise;
    } catch (p) {
  ...
  function ci(
    n,
    u = typeof de() == 'number' ? de() : n.maxNumber || n.maxnumber || We(),
    h = Math.ceil(ut())
  ) {
    const p = new AbortController(),
      g = [];
    h = Math.min(16, u, Math.max(1, h));
    for (let H = 0; H < h; H++) g.push(altchaCreateWorker(kt()));
            ...
            return (
              ...
              new Promise(Qe => {
                (q.addEventListener('message', dt => {
                  if (dt.data) for (const et of g) et !== q && et.postMessage({ type: 'abort' });
                  Qe(dt.data);
                }),
                  q.postMessage({
                    payload: n,
  ...
  async function $t() {
    ...
    if (!n || !('clarify' in n)) {
      (xe(y.ERROR),
        A('Plugin `obfuscation` not found. Import `altcha/plugins/obfuscation` to load it.'));
      return;
    }
    if ('clarify' in n && typeof n.clarify == 'function') return n.clarify();
  }
  function bn(n) {
    (n.obfuscated !== void 0 && Ne(n.obfuscated),
      n.auto !== void 0 && (a(n.auto), a() === 'onload' && (Ne() ? $t() : Se())),
      n.blockspam !== void 0 && s(!!n.blockspam),
      n.customfetch !== void 0 && m(n.customfetch),
      n.floatinganchor !== void 0 && ee(n.floatinganchor),
      n.delay !== void 0 && _(n.delay),
      n.floatingoffset !== void 0 && $e(n.floatingoffset),
      n.floating !== void 0 && gn(n.floating),
      n.expire !== void 0 && (xr(n.expire), U(n.expire)),
      n.challenge &&
        (f(typeof n.challenge == 'string' ? n.challenge : JSON.stringify(n.challenge)), mn(i(Wt))),
      n.challengeurl !== void 0 && c(n.challengeurl),
      n.debug !== void 0 && v(!!n.debug),
      n.hidefooter !== void 0 && j(!!n.hidefooter),
      n.hidelogo !== void 0 && se(!!n.hidelogo),
      n.language !== void 0 && st(Qr(l(), [n.language])),
      n.maxnumber !== void 0 && We(+n.maxnumber),
      n.mockerror !== void 0 && xt(!!n.mockerror),
      n.name !== void 0 && Ge(n.name),
      n.overlaycontent !== void 0 && Ct(n.overlaycontent),
      n.overlay !== void 0 && pn(n.overlay),
      n.refetchonexpire !== void 0 && M(!n.refetchonexpire),
      n.disablerefetchonexpire !== void 0 && M(!n.disablerefetchonexpire),
      n.sentinel !== void 0 && typeof n.sentinel == 'object' && Ye(n.sentinel),
      n.spamfilter !== void 0 &&
        ye(typeof n.spamfilter == 'object' ? n.spamfilter : !!n.spamfilter),
      n.strings && st(typeof n.strings == 'string' ? n.strings : JSON.stringify(n.strings)),
      n.test !== void 0 && de(typeof n.test == 'number' ? n.test : !!n.test),
      n.verifyurl !== void 0 && te(n.verifyurl),
      n.workers !== void 0 && ut(+n.workers),
      n.workerurl !== void 0 && kt(n.workerurl));
  }
  function yn() {
    return {
      auto: a(),
  ...
  function Tt(n = 20) {
    if (i(V))
      if (
        ...
        const u = parseInt($e(), 10) || 12,
          h = i(ct).getBoundingClientRect(),
          p = i(V).getBoundingClientRect(),
          g = document.documentElement.clientHeight,
          C = document.documentElement.clientWidth,
          D = I() === 'auto' ? h.bottom + p.height + u + n > g : I() === 'top',
          H = Math.max(n, Math.min(C - n - p.width, h.left + h.width / 2 - p.width / 2));
        if (
          (D
            ? (i(V).style.top = `${h.top - (p.height + u)}px`)
            : (i(V).style.top = `${h.bottom + u}px`),
          (i(V).style.left = `${H}px`),
          i(V).setAttribute('data-floating', D ? 'top' : 'bottom'),
          i(It))
        ) {
          const q = i(It).getBoundingClientRect();
          i(It).style.left = h.left - H + h.width / 2 - q.width / 2 + 'px';
        }
      } else A('unable to find floating anchor element');
  }
  function Ke(n = y.UNVERIFIED, u = null) {
    (i(Ze) && (i(Ze).abort(), b(Ze, null)),
      b(At, !1),
      b(Ee, null),
      b(G, null),
      b(wr, !1),
  ...
  async function Se() {
    return (
      Ke(y.VERIFYING),
      await new Promise(n => setTimeout(n, _() || 0)),
      Jo()
        .then(n => (mn(n), A('challenge', n), _n(n)))
        .then(({ data: n, solution: u }) => {
            ...
            if (u?.number !== void 0 && 'challenge' in n)
              if (te() && 'codeChallenge' in n)
                (['INPUT', 'BUTTON', 'SELECT', 'TEXTAREA'].includes(
                  ...
                  b(G, { challenge: n, solution: u }, !0));
              else {
                if (te() && Ye() !== void 0) return hn(Yt(n, u));
                if (te()) return ui(Yt(n, u));
  ...
  var Xe = J(In, 2);
  (qn(Xe),
    (Xe.__change = [ul, k, ye, T, At, Ne, $t, Se]),
    Qt(
      Xe,
      n => b(yr, n),
      () => i(yr)
    ...
    var bi = n => {
        ...
        H = z(D);
      {
        var q = pe => {
          ...
          (Z(Y),
            Ce(() => {
              (R(Y, 'title', i(L).getAudioChallenge),
                (Y.disabled = i(W) === Q.LOADING || i(W) === Q.ERROR || i(Je)),
                R(Y, 'aria-label', i(W) === Q.LOADING ? i(L).loading : i(L).getAudioChallenge));
            }),
            B(pe, Y));
        };
        K(H, pe => {
      ...
      (Z(h),
        ...
        Ce(() => {
          (R(u, 'aria-label', i(L).verificationRequired),
            R(p, 'src', i(G).challenge.codeChallenge.image),
            R(g, 'minlength', i(G).challenge.codeChallenge.length || 1),
            R(g, 'maxlength', i(G).challenge.codeChallenge.length),
            R(g, 'placeholder', i(L).enterCode),
            R(
              g,
              'aria-label',
              i(W) === Q.LOADING ? i(L).loading : i(W) === Q.PLAYING ? '' : i(L).enterCodeAria
            ),
            R(g, 'aria-live', i(W) ? 'assertive' : 'polite'),
            R(g, 'aria-busy', i(W) === Q.LOADING),
            (g.disabled = i(Je)),
            R(oe, 'aria-label', i(L).reload),
            R(oe, 'title', i(L).reload),
            (oe.disabled = i(Je)),
            (ie.disabled = i(Je)),
            R(ie, 'aria-label', i(L).verify),
            La(et, ` ${i(L).verify ?? ''}`));
        }),
        Fe('submit', h, ai, !0),
        B(n, u));
  ...
  (Z(ft),
    ...
    Ce(
      n => {
        (R(ft, 'data-state', i(k)),
          R(ft, 'data-floating', I()),
          R(ft, 'data-overlay', ge()),
          (An = Va(zt, 1, 'altcha-checkbox', null, An, n)),
          R(Xe, 'id', i(Kr)),
          (Xe.required = a() !== 'onsubmit' && (!I() || a() !== 'off')),
          R(Jt, 'for', i(Kr)));
      },
      [
        () => ({
