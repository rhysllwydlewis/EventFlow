...
(async function () {
  ...
  function loadCustomerDashboardMopUp() {
    loadCustomerScript('customer-dashboard-mop-up-script', '/assets/js/customer-dashboard-mop-up.js?v=1.0.2');
    loadCustomerScript('customer-dashboard-polish-script', '/assets/js/customer-dashboard-polish.js?v=1.0.2');
  }
