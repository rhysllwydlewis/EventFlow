(function () {
  ...
  function mailIcon(size) {
    return (
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" width="' +
      (size || 24) +
      '" height="' +
      (size || 24) +
      '"><rect x="2" y="4" width="20" height="16" rx="3"></rect><path d="M2 8l10 6 10-6"></path></svg>'
    );
  }
  ...
  function renderNewsletter() {
    return (
      '<section class="ef-nl-wrap" aria-label="Stay Updated newsletter signup"><div class="ef-nl-card"><div class="ef-nl-left"><div class="ef-nl-icon">' +
      mailIcon(28) +
      '</div><div class="ef-nl-copy"><h2>Stay Updated</h2><p>Get the latest event planning tips, supplier spotlights, and special offers delivered to your inbox.</p></div></div><div class="ef-nl-divider" aria-hidden="true"></div><div class="ef-nl-right"><form class="ef-nl-row" novalidate><label class="ef-nl-input-wrap" for="ef-footer-email">' +
      mailIcon(18) +
      '<span class="ef-footer-sr-only">Email address</span><input id="ef-footer-email" name="email" type="email" placeholder="Enter your email address" autocomplete="email" required></label><button class="ef-nl-btn" type="submit">Subscribe</button></form><p class="ef-nl-note">We respect your privacy. Unsubscribe at any time.</p><p class="ef-nl-feedback" aria-live="polite"></p></div></div></section>'
    );
  }
  ...
  function renderFooterHtml(year) {
    return (
      footerWaves() +
      renderNewsletter() +
      '<div class="ef-footer-inner"><div class="ef-footer-brand"><a href="/" class="ef-brand-logo" aria-label="EventFlow home"><span class="ef-brand-logo-name">EventFlow</span></a><p class="ef-brand-tagline">Event planning made simple.</p><p class="ef-brand-operated">Operated by <a href="https://vexi.co.uk" target="_blank" rel="noopener noreferrer">VEXI</a></p><div class="ef-socials"><a href="https://www.instagram.com/eventflowuk" class="ef-social-link" aria-label="EventFlow on Instagram" target="_blank" rel="noopener noreferrer">' +
      socialIcon('instagram') +
      '</a><a href="https://www.facebook.com/eventflowuk" class="ef-social-link" aria-label="EventFlow on Facebook" target="_blank" rel="noopener noreferrer">' +
      socialIcon('facebook') +
      '</a><a href="https://www.linkedin.com/company/eventflowuk" class="ef-social-link" aria-label="EventFlow on LinkedIn" target="_blank" rel="noopener noreferrer">' +
      socialIcon('linkedin') +
      '</a></div></div><nav class="ef-footer-nav" aria-label="Platform links"><div class="ef-nav-head"><div class="ef-nav-head-icon">' +
      navIcon('platform') +
      '</div><span class="ef-nav-head-label">Platform</span></div><ul class="ef-nav-list"><li><a href="/start">Plan an Event</a></li><li><a href="/suppliers">Browse Suppliers</a></li><li><a href="/marketplace">Marketplace</a></li><li><a href="/pricing">Pricing</a></li></ul></nav><nav class="ef-footer-nav" aria-label="Resources links"><div class="ef-nav-head"><div class="ef-nav-head-icon">' +
      navIcon('resources') +
      '</div><span class="ef-nav-head-label">Resources</span></div><ul class="ef-nav-list"><li><a href="/guides">Guides</a></li><li><a href="/faq">FAQ</a></li><li><a href="/for-suppliers">For Suppliers</a></li><li><a href="/contact">Contact</a></li></ul></nav><nav class="ef-footer-nav" aria-label="Legal links"><div class="ef-nav-head"><div class="ef-nav-head-icon">' +
      navIcon('legal') +
      '</div><span class="ef-nav-head-label">Legal</span></div><ul class="ef-nav-list"><li><a href="/legal">Legal Hub</a></li><li><a href="/privacy">Privacy Policy</a></li><li><a href="/terms">Terms of Service</a></li><li><button type="button" class="ef-cookie-link" data-cookie-prefs>Cookie preferences</button></li></ul></nav></div><div class="ef-footer-bar"><div class="ef-footer-bar-inner"><p>© 2025–' +
      year +
      ' EventFlow. All rights reserved.</p></div></div>'
    );
  }
