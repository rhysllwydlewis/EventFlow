(function () {
  ...
  function footerLogo() {
    return (
      '<svg class="ef-brand-logo-icon" viewBox="0 0 32 32" fill="none" ' +
  ...
  function footerWaves() {
    return (
      '<svg class="ef-footer-waves" viewBox="0 0 440 260" fill="none" ' +
      'xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' +
  ...
  function renderFooterHtml(year) {
    return (
      ...
      '<div class="ef-nav-head">' +
      '<div class="ef-nav-head-icon">' +
      navIcon('platform') +
      '</div>' +
      '<span class="ef-nav-head-label">Platform</span>' +
      '</div>' +
      ...
      navIcon('resources') +
      '</div>' +
      '<span class="ef-nav-head-label">Resources</span>' +
      '</div>' +
      '<ul class="ef-nav-list">' +
      ...
      navIcon('legal') +
      '</div>' +
      '<span class="ef-nav-head-label">Legal</span>' +
      '</div>' +
      '<ul class="ef-nav-list">' +
      ...
      '</nav>' +
      '</div>' +
      '<div class="ef-footer-bar">' +
      '<div class="ef-footer-bar-inner">' +
