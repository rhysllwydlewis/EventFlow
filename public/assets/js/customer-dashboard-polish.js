(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .customer-dashboard-page #welcome-section .customer-welcome-actions__grid {
        gap: .85rem !important;
      }
      ...
      .customer-dashboard-page .ef-dashboard-card--collapsible {
        overflow: hidden;
      ...
      .customer-dashboard-page .ef-dashboard-collapse-toggle {
        display:inline-flex;align-items:center;justify-content:center;gap:.42rem;min-height:2.25rem;padding:.48rem .75rem;border-radius:999px;border:1px solid rgba(11,128,115,.18);background:linear-gradient(135deg,rgba(255,255,255,.96),rgba(240,253,250,.9));color:#0b8073;cursor:pointer;font-family:inherit;font-size:.8rem;font-weight:850;line-height:1;box-shadow:0 8px 18px rgba(15,23,42,.06),inset 0 1px 0 rgba(255,255,255,.86);transition:transform .16s ease,background .16s ease,border-color .16s ease,box-shadow .16s ease;
      }
