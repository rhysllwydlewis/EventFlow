...
(() => {
    ...
    function initialiseHeroGuide() {
        ...
        const compactViewport = typeof window.matchMedia === 'function' && window.matchMedia('(max-width: 960px)').matches;
      ...
      `;
        ...
        function findGuideTarget(variant) {
            ...
            return (document.querySelector('a[href="/login"], a[href="/login.html"], a[href*="/login"]') ||
        ...
        function placeGuide(guide, target, variant, measuredTargetRect) {
            ...
            const avoidRect = variant === 'search' && measuredTargetRect ? measuredTargetRect : findGuideAvoidRect(target, variant);
        ...
        function showGuide(config, duration, onRemoved) {
            ...
            const initialRect = config.variant === 'search' ? findGuideAvoidRect(target, config.variant) : target.getBoundingClientRect();
        ...
        const showTimer = queue(() => {
            ...
            }, 6400, () => queue(showSignUpGuide, 850));
        }, 1000);
