    ...
    try {
      ...
      <div style="flex:1;min-width:0;">
        ...
        <div style="display:flex;gap:0.5rem;flex-wrap:wrap;margin-top:0.75rem;margin-bottom:0.5rem;">
          ...
          <button type="button" class="supplier-profile-photo-remove" data-profile-id="${supplierId}" style="font-size:0.82rem;padding:0.375rem 0.875rem;border-radius:6px;border:1px solid #d1d5db;background:#fff;color:#dc2626;cursor:pointer;display:inline-flex;align-items:center;gap:0.35rem;" aria-label="Remove profile photo">
