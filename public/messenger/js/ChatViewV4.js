  ...
  render() {
    this.container.innerHTML = `
      <div class="messenger-v4__chat-header" id="v4ChatHeader" style="display:none">
        ...
        <button class="ef-cta messenger-v4__action-button" id="v4BackBtn" aria-label="Back to list" title="Back" style="display:none">
      ...
      <button class="ef-cta messenger-v4__scroll-to-bottom" id="v4ScrollToBottom" aria-label="Scroll to latest message" style="display:none">
      ...
      <div class="messenger-v4__lightbox" id="v4Lightbox" role="dialog" aria-modal="true" aria-label="Image preview" style="display:none">
        <button class="ef-cta messenger-v4__lightbox-close" id="v4LightboxClose" aria-label="Close image preview">
  ...
  _toggleContextMenu(btn) {
    ...
    const menuHtml = MessageBubbleV4
      ...
      : `<div class="messenger-v4__context-menu" role="menu">
           <button class="ef-cta messenger-v4__context-menu-item" data-action="copy" data-id="${this.escape(messageId)}">
           ...
           ${
             isOwn
               ? `<button class="ef-cta messenger-v4__context-menu-item messenger-v4__context-menu-item--danger" data-action="delete" data-id="${this.escape(messageId)}">
