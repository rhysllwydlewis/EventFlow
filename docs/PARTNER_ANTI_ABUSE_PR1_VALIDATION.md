...
A temporary read-only diagnostic run is producing exact formatter output and changed-line coverage evidence for the remaining corrections. The diagnostic workflow will be removed before merge validation.
