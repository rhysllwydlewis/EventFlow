...
- Messaging and media uploads: the existing Privacy Notice already describes messages, enquiries, photos and file storage. No material change to those features appeared in the ten-PR window.
...
- **Privacy Notice:** adds Community data and retention, location/geocoding, Pexels, PostHog, Sentry, analytics storage and public indexing.
