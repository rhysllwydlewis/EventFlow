...
const HOMEPAGE_V3_HERO_STYLES = [
  ...
  '    <link rel="preload" href="/assets/css/home-v3.css?v=4" as="style" />',
  '    <link rel="stylesheet" href="/assets/css/home-v2.css?v=11" />',
  '    <link rel="stylesheet" href="/assets/css/home-v3.css?v=4" />',
  '    <script src="/assets/js/pages/home-v3.js?v=3"></script>',
].join('\n');
