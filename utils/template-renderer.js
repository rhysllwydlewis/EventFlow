...
const HOMEPAGE_V3_HERO_STYLES = [
  ...
  '    <link rel="preload" href="/assets/css/home-v3-mobile.css?v=6" as="style" media="(max-width: 960px)" />',
  '    <link rel="stylesheet" href="/assets/css/home-v3-mobile.css?v=6" media="(max-width: 960px)" />',
